    ...
    <div className="mb-20 cartItem d-flex align-center">
      ...
      <div className="card">
        ...
        <img src="/img/heart-unliked.svg" alt="Unliked" />
          ...
          <img width={133} height={112} src="img/pic/1.png"/>
      ...
      <div className="card">
          <img width={133} height={112} src="img/pic/2.png"/>
          <h5>Мужские Кроссовки Nike Air Max 270</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
            <span>Цена:</span>
      ...
      <div className="card">
          <img width={133} height={112} src="img/pic/3.png"/>
          <h5>Мужские Кроссовки Nike Air Max 270</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
            <span>Цена:</span>
      ...
      <div className="card">
          <img width={133} height={112} src="img/pic/4.png"/>
          <h5>Мужские Кроссовки Nike Air Max 270</h5>
          <div className="d-flex justify-between align-center">
            <div className="d-flex flex-column">
            <span>Цена:</span>
